...
from defensive_perturbation import defensive_perturbation
...
if __name__ == '__main__':
    ...
    with tf.device(device):
        ...
        file_perturbation = os.path.join('data', 'defensive.npy')##################
        ...
        if os.path.isfile(file_perturbation) == 0:
            ...
            v = defensive_perturbation(X, f, grad_fs, delta=0.2, num_classes=num_classes)
