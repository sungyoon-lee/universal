...
if __name__ == '__main__':
    ...
    path_test_image = 'data/test_im7.jpg'
    ...
    with tf.device(device):
        ...
        image_ROF_5 = denoise_tv_chambolle(image_original, weight=5, multichannel=True)
        ...
        image_denoised_5 = denoise_tv_chambolle(image_perturbed, weight=5, multichannel=True)
        ...
        plt.subplot(2, 4, 2)
        plt.imshow(undo_image_avg(image_ROF_5[0, :, :, :]).astype(dtype='uint8'), interpolation=None)
        ...
        plt.subplot(2, 4, 6)
        plt.imshow(undo_image_avg(image_denoised_5[0, :, :, :]).astype(dtype='uint8'), interpolation=None)
